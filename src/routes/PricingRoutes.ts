...
import { getAllApiQueryParams, idInParams,getSingleApiQueryParams3, createUpdateCategory, idAndCategoryInParams, categoryIdInParams, createUpdateLanguage, createSubscriptionEntry } from "../validations/CommonValidations";
...
export default function (server: Hapi.Server) {
    ...
    const controller = new PricingController(server);
    server.bind(controller);
    let isAuthRequired = false;
    let resourceName = 'subscriptions';
